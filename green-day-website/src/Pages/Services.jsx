...
import brownpatch from '../assets/brownpatch.jpg';
import soiltesting from '../assets/soiltesting.jpg';
import lawnrenovation from '../assets/lawnrenovation.jpg';
            ...
            <Box sx={style.cardContainer}>
                ...
                <Box sx={{flex: 1, p: 2, display: 'flex', flexDirection: 'column'}}>
                    <Card sx={{ margin: 2, padding: 2, backgroundColor: '#E8F5E9', display: 'flex', flexDirection: 'column', height: '100%' }}>
                        ...
                        <img src={brownpatch} alt="Brown Patch" style={{ width: '50%', marginTop: '8%', borderRadius: '5px', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
                    </Card>
                </Box>
            </Box>
                <Box sx={style.cardContainer}>
                    <Box sx={{flex: 1, p: 2, display: 'flex', flexDirection: 'column'}}>
                        ...
                        <img src={lawnrenovation} alt="Lawn Renovation" style={{ width: '50%', marginTop: '8%', borderRadius: '5px', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
                    </Card>
                    </Box>
                    <Box sx={{flex: 1, p: 2, display: 'flex', flexDirection: 'column'}}>
                    <Card sx={{ margin: 2, padding: 2, backgroundColor: '#E8F5E9', display: 'flex', flexDirection: 'column', height: '100%' }}>
                        ...
                        <img src={pestcontrol} alt="Pest Control" style={{ width: '50%', marginTop: '8%', borderRadius: '5px', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
                    </Card>
                </Box>
            </Box>
            <Box sx={style.cardContainer}>  
                <Box sx={{flex: 1, p: 2, display: 'flex', flexDirection: 'column'}}>
                    <Card sx={{ margin: 2, padding: 2, backgroundColor: '#E8F5E9', display: 'flex', flexDirection: 'column', height: '100%' }}>
                        ...
                        <img src={soiltesting} alt="Soil Testing" style={{ width: '50%', marginTop: '15px', borderRadius: '5px', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
					</Card>
                </Box>
                <Box sx={{ flex: 1, p: 2, display: 'flex', flexDirection: 'column'}}>  
                    <Card sx={{ margin: 2, padding: 2, backgroundColor: '#E8F5E9', display: 'flex', flexDirection: 'column', height: '100%' }}>
                        ...
                        <Typography variant="body1" component="div" align="center" sx={{justifyContent: 'center', display: 'flex', marginBottom: 2}}>
